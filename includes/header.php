        ...
        <div class="container-menu-desktop">
            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    Online BookStore | CITY MALL MOULANA AZAD ROAD LAL CHOWK SRINAGAR J&K -190001 | +91 70069 78415 | onlinebookstore@gmail.com
                       &nbsp;
                    </div>
...
<?php if($_SESSION['id']==0){?>
                        <a href="signup.php"style="border:1px solid #007bff;border-radius:5px;margin-bottom:3px;background-color:black;"class="flex-c-m trans-04 p-lr-25">
                            Registration
                        </a>

                        <a href="login.php" style="border:1px solid #007bff;border-radius:5px;margin-bottom:3px;background-color:black;"class="flex-c-m trans-04 p-lr-25">
                            Login
                        </a>
<?php } else {?>
                        <a href="logout.php" style="border:1px solid #007bff;border-radius:5px;margin-bottom:3px;background-color:black;" class="flex-c-m trans-04 p-lr-25">
                            Logout
                        </a><?php } ?>  
                    </div>
                </div>
