...
(8, 10, 'Watlab Sopore', 'srinagar ', 'J&K', 193201, 'India', 'Watlab Sopore', 'srinagar ', 'J&K', 193201, 'India', '2025-01-25 07:39:23');
...
(35, 10, 15, 1, '2025-03-19 05:16:32');
...
(13, 711142575, 10, 8, 1500.00, 'Cash on Delivery', '', 'Cancelled', '2025-01-25 07:39:40'),
(14, 544012803, 10, 8, 800.00, 'Cash on Delivery', '', 'Delivered', '2025-01-25 10:52:55'),
(15, 716831734, 10, 8, 2300.00, 'Cash on Delivery', '', 'Delivered', '2025-01-28 08:03:12'),
(16, 607460709, 10, 8, 1500.00, 'Cash on Delivery', '', 'Delivered', '2025-02-24 11:50:49');
...
(23, 711142575, 10, 15, 1, '2025-01-25 07:39:40', NULL),
(24, 544012803, 10, 14, 1, '2025-01-25 10:52:55', NULL),
(25, 716831734, 10, 14, 1, '2025-01-28 08:03:12', NULL),
(26, 716831734, 10, 15, 1, '2025-01-28 08:03:12', NULL),
(27, 607460709, 10, 15, 1, '2025-02-24 11:50:49', NULL);
...
(24, 13, 'Packed', 'Your Order is packed by the seller', 1, '2025-01-25 07:41:16', NULL),
(25, 13, 'Cancelled', 'not needed now', NULL, '2025-01-25 07:42:55', 'User'),
(26, 14, 'Delivered', 'Order delivered successfully', 1, '2025-01-25 10:53:56', NULL),
(27, 15, 'Packed', 'Your order is packed and waiting for pickup', 1, '2025-01-28 08:04:41', NULL),
(28, 15, 'Delivered', 'deliverd  successfully', 1, '2025-01-28 08:06:14', NULL),
(29, 16, 'Packed', 'Your Order is Packed and waiting for dispach', 1, '2025-02-24 11:51:54', NULL),
(30, 16, 'In Transit', 'Your order is dispatched through India Post and is in Transit', 1, '2025-02-24 11:53:07', NULL),
(31, 16, 'Out For Delivery', 'Your Order is received at Nearest Branch and is out for delivery. your order will be delivered from 9:00 AM to 7:00 PM Today', 1, '2025-02-24 11:54:39', NULL),
(32, 16, 'Delivered', 'Order Delivered successfully', 1, '2025-02-24 11:54:59', NULL);
...
(1, 'aboutus', 'About us', 'Welcome to the Online Bookstore, your ultimate destination for all things literary! Our digital shelves are brimming with an extensive range of books, spanning fiction and nonfiction genres, catering to all ages and interests. In addition to physical books, we also offer a diverse collection of audiobooks, ebooks, and magazines.\r\n\r\nWe passionately believe that everyone deserves access to books. That\'s why we provide a 100% satisfaction guarantee, ensuring you receive the best value for your money.\r\n\r\nOur dedicated team of book experts is always ready to assist you in finding the perfect read. Whether you need a recommendation based on your interests or a specific occasion, we\'ve got you covered.\r\n\r\nWe are committed to delivering an exceptional shopping experience. We offer multiple payment options, and our hassle-free return or exchange policy ensures peace of mind. Plus, enjoy regular promotions and discounts that make building your dream library even more rewarding.\r\n\r\nHappy reading! 📚\r\nWe hope you will visit Online Bookstore today and find the perfect book for you!\r\n\r\n', NULL, NULL, '2025-02-24 10:13:19'),
(2, 'contactus', 'Contact Us', 'CITY MALL MOULANA AZAD ROAD LAL CHOWK SRINAGAR J&K -190001 ', 'onlinebookstore@gmail.com', 7006978415, '2025-02-24 10:12:02');
...
(10, 'Himayat Habib', 'reshihimayat7@gmail.com', 6005566118, 'c524f58c6079fc864860acaf2e98c952', '2025-01-25 07:37:12', NULL),
(11, 'User', 'user@user.com', 9876543210, '448ddd517d3abb70045aea6929f02367', '2025-02-06 04:56:15', NULL);
